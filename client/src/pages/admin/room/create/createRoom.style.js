...
import { DoorClosed, Loader2, Upload, Search } from "lucide-react";
...
export const HeaderIcon = styled(DoorClosed)`
  margin: 0 auto 20px;
  display: block;
  position: relative;
  z-index: 1;
...
export const RoomTypeSection = styled.div`
  background: #f9fafb;
  border: 2px solid #e5e7eb;
  border-radius: 16px;
  padding: 24px;
...
export const RoomTypeHeader = styled.h3`
  font-size: 16px;
  font-weight: 700;
  color: #1a202c;
  margin: 0 0 16px 0;
  padding-bottom: 10px;
  border-bottom: 2px solid #af5cb8ff;
  display: flex;
  align-items: center;
  gap: 8px;
`;
